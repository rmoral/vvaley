...
export default async function NewsletterConfirmedPage({
  ...
  return (
    <main className="mx-auto max-w-xl px-6 pb-24 pt-40 text-center md:px-16">
      <div className="mb-3 text-[0.74rem] font-semibold uppercase tracking-[0.2em] text-river">
        {t("confirmed_eyebrow")}
      </div>
      <h1 className="mb-4 font-display text-[clamp(2rem,4vw,2.8rem)] font-black leading-[1.1] text-text">
        {t("confirmed_title")}
      </h1>
      <p className="mb-8 text-[1rem] leading-[1.7] text-text-2">
        {t("confirmed_body")}
      </p>
      <Link
        href="/"
